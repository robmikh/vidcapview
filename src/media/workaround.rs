use windows::{
    ...
    Win32::Media::MediaFoundation::{
        FORMAT_VideoInfo, FORMAT_VideoInfo2, MFAudioFormat_AAC, MFAudioFormat_ADTS,
        MFAudioFormat_DRM, MFAudioFormat_DTS, MFAudioFormat_Dolby_AC3_SPDIF, MFAudioFormat_Float,
        ...
        MFAudioFormat_WMAudio_Lossless, MFMediaType_Audio, MFMediaType_Binary,
        MFMediaType_FileTransfer, MFMediaType_HTML, MFMediaType_Image, MFMediaType_Protected,
        MFMediaType_SAMI, MFMediaType_Script, MFMediaType_Video, MFVideoFormat_AI44,
        ...
        MFVideoFormat_v410, MF_MT_AAC_AUDIO_PROFILE_LEVEL_INDICATION, MF_MT_AAC_PAYLOAD_TYPE,
        ...
        MF_MT_ORIGINAL_4CC, MF_MT_ORIGINAL_WAVE_FORMAT_TAG, MF_MT_PAD_CONTROL_FLAGS, MF_MT_PALETTE,
